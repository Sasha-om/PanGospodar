...
const deliveryMethods = [
  ...
  },
  {
    ...
    description:
      "Доставка до найближчого відділення перевізника («Нової Пошти», «Укрпошти» та іншого) або його кур'єрською службою за вашою адресою — даним способом можна замовити цю продукцію фірми Stihl: приладдя, AC, AK системи, мийки, пилососи.",
  },
  {
    step: "3",
