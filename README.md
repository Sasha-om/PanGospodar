...
### Чого ще немає (потребує зовнішнього сервісу)

- **Капча** після N невдалих спроб. Ліміти вище зупиняють перебір одного
  акаунта, але не «одну паролю до тисячі акаунтів». Захист від цього —
  Cloudflare Turnstile або hCaptcha; обидва потребують реєстрації та ключів.
